          ...
          return (
            <li key={p.forslagspunkt_id}>
              <Link
                ...
                className="grid items-start gap-x-8 gap-y-4 py-6 transition-colors duration-150 hover:bg-[var(--papper-djup)] md:grid-cols-[1fr_356px]"
            ...
            {sidnummer(d.nr, d.sidor).map((n, i) =>
              n === null ? (
                ...
                <span
                  key={n}
                  aria-current="page"
                  className="traffyta tabular rounded-full px-3.5 py-2.5 text-[14px] font-semibold"
                  style={{ background: 'var(--black)', color: 'var(--papper)' }}
                >
                  {n}
                </span>
                ...
                <Link
                  ...
                  className="traffyta tabular rounded-full px-3.5 py-2.5 text-[14px] transition-colors duration-150 hover:bg-[var(--papper-djup)]"
